...
<div class="card">
    <div class="top">
        <div>
            ...
            <div style="color:#64748b;font-size:13px;margin-top:4px;">Manage required equipment used inside Tests.</div>
        </div>
        <a class="btn" href="{{ route('equipment.create') }}">+ Add Equipment</a>
    </div>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <form action="{{ route('equipment.destroy', $item) }}" method="POST" style="display:inline;">
                            @csrf
                            @method('DELETE')
                            <button onclick="return confirm('Delete this equipment?')">Delete</button>
                        </form>
                    </td>
                </tr>
            @empty
