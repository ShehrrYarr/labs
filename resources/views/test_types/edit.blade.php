...
<div class="wrap">
    <div class="card">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:12px;flex-wrap:wrap;">
            <div>
                <h2 style="margin:0;color:#0f172a;">Edit Test Type</h2>
                <div style="color:#64748b;font-size:13px;margin-top:4px;">Update name and status.</div>
            </div>
        ...
        <form method="POST" action="{{ route('test-types.update', $testType) }}">
            @csrf
            @method('PUT')
            ...
            <div style="margin-top:14px;">
                <label>Price</label>
                <input type="text" name="price" value="{{ old('price', $testType->price) }}" required>
            </div>
            <div style="margin-top:14px;">
                <label>Code</label>
